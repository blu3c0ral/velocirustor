...
pub trait VehicleSteeringAPI {
    ...
    fn steer_by_pos(&self, abs_pos: i32, power: i8) -> Result<()> {unimplemented!()}
    fn steer_until_stopped(&self, direction: i8, power: i8) -> Result<()> {unimplemented!()}
...
pub trait VehicleMotorAPI {
    ...
    fn activate_motor_until_stopped(&self, direction: u8, power: i8) -> Result<()> {unimplemented!()}
